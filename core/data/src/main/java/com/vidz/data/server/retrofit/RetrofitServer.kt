...
@Singleton
class RetrofitServer @Inject constructor(
    private val retrofit: Retrofit,
    @Named("GoongRetrofit") private val goongRetrofit: Retrofit
) {
    ...
    val mapApi: MapApi by lazy { goongRetrofit.create(MapApi::class.java) }
}
